...
function renderIncomeTransactions(loadMore = false) {
    ...
    const incomeList = transactions.filter(t => t.type === 'income' && transactionBelongsToFilter(t));
...
function renderSpendingTransactions(loadMore = false) {
    ...
    const expenseList = transactions.filter(t => t.type === 'expense' && transactionBelongsToFilter(t));
